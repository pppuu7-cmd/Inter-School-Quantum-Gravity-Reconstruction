...
- classification `DED_DLD_FIGURE_ONLY_REQUIRES_MANUAL_INCIDENCE_AUDIT`
- `machine_incidence_ready=false`.
...
1. Lorentzian refinement: preregister an independent dual-representation EPS topology-reconstruction diagnostic before implementation. Its purpose is only to determine whether the DED/DLD figures permit a reproducible machine topology reconstruction; no bridge credit is allowed unless an explicit incidence-preserving embedding is recovered and reproduced independently.
